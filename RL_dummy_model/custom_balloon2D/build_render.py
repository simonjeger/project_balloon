...
def build_render(character, reward, world_name, window_size, train_or_test):
    ...
    reward = myfont.render('reward: ' + str(round(reward,2)), False, pygame.Color('LightGray'))
    ...
    screen.blit(reward,(10,25))
    screen.blit(residual,(10,40))
    screen.blit(border,(10,55))
