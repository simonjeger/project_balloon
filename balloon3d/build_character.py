    ...
    def move_particle(self, n):
        ...
        for _ in range(n):
            ...
            if in_bounds:
                ...
                # find min_distance
                min_distance = np.sqrt(((self.position[0]-self.target[0])*self.render_ratio)**2 + ((self.position[1]-self.target[1])*self.render_ratio)**2 + (self.position[2]-self.target[2])**2)
