...
def build_render(character, reward_step, reward_epi, world_name, window_size, radius_xy, radius_z, train_or_test, roll_out):
    ...
    if yaml_p['type'] == 'regular':
        ...
        t_rel_pos = myfont.render('rel_pos: ' + str([round(num, 3) for num in character.state[9:12].tolist()]), False, pygame.Color('LightGray'))
    ...
    screen.blit(t_rel_pos,(space_text,start_text+6*space_text))
    screen.blit(t_measurement,(space_text,start_text+7*space_text))
